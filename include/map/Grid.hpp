...
class Grid
{
    ...
    const tile_t* data() const;

    tile_t& operator[](const std::size_t& index);
    const tile_t& operator[](const std::size_t& index) const;
    tile_t& at(const std::size_t& index);
    const tile_t& at(const std::size_t& index) const;
