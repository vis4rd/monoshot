...
void SettingsSection::render() noexcept
{
    ...
    auto menu_x = viewport_x + 40.f * scale_w;
    auto menu_y = viewport_y + 40.f * scale_h;
    ...
    ImGui::Begin("Main Menu", nullptr, window_flags);
    {
        ...
        if(ImGui::BeginCombo("Resolution", current_resolution.c_str()))
        {
        ...
        else if(ImGui::Button("Close", {button_w, button_h}))
        {
